...
export default class Store {
	...
	getDeck(): Promise<string> {
		return this.getOption('deck', "Default");
	}
	setDeck(deck: string) {
	...
	getCardType(): Promise<string> {
		return this.getOption('cardType', "Default");
	}
	...
	getWordField(): Promise<string> {
		return this.getOption('wordField', "Front");
	}
	...
	getTranslationField(): Promise<string> {
		return this.getOption('translationField', "Back");
	}
